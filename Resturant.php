...
<body>
    ...
    <div class="containner">
        ...
        <section class="landing">
            <div class="about-ev">
                <h1>TREAT FOR YOUR SOUL</h1>
                <p>Good restaurant service is not just about being friendly 
                    and helpful. It is about going above and beyond to make 
                    sure that our customers have a positive experience. It is
                about creating a warm and inviting atmosphere where our customers
                 feel comfortable and relaxed. And it is about providing excellent
                  food and drink that our customers will love.</p>
            </div>
        </section>
            ...
            <div class="event-content">
                <div class="box">
                    <div class="ev event-details">
                        <h2>Drinks</h2>
                        <p> At our restaurant, we believe that great food deserves great drinks. That's 
                            why we offer a wide variety of drinks to complement our menu. Whether you're 
                            looking for something refreshing, something 
                            to warm you up, or something to enjoy with your
                             meal, we have something for you.</p>
                        <button class="event-btn" > <a href="resmenu.php" >Go to the menu </a></button>
                    </div>
                ...
                <div class="box2">
                    <div class="ev event-details2">
                        <h2>Foods</h2>
                        <p> At our restaurant, we believe that food should be delicious, 
                            nutritious, and affordable. That's why we offer 
                            a wide variety of dishes that are made with fresh,
